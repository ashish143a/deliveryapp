        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 15),
              inputWidget(Translations.of(context).password, emailController, true),
              SizedBox(height: 20),
              Container(
                ...
                child: RichText(
                  text: TextSpan(
                    children: <TextSpan>[
                      TextSpan(
                          text: Translations.of(context).accept,
                          style: TextStyle(color: Colors.black45)),
                      TextSpan(
                          text: Translations.of(context).term,
                          style: TextStyle(
                              color: Colors.blue,
              ...
              Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                            text: Translations.of(context).haveaccount,
                            style: TextStyle(color: Colors.black45)),
                        TextSpan(
